"""
Django settings for aste_project project.
...
SECRET_KEY = 'django-insecure-^%z%ay1d5pr$ldo0^7353$s024&9t3lq*db2t1nxm8te@h--j*'
...
ROOT_URLCONF = 'aste_project.urls'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # Cartella per i file raccolti in produzione
